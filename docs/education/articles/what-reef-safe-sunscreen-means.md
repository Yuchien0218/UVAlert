...
目前不能把「reef-safe」「reef-friendly」或「海洋友善」視為全球統一、由單一官方核發的保證。AAD 與夏威夷自然資源主管機關都提醒，這類用語沒有一致的管制定義。
...
不同研究使用的物種、濃度與環境條件不同，真實海域的影響也仍在研究。成分以外，使用量、遊客密度、污水與氣候壓力都可能影響珊瑚生態。

---

## 文章限制

本文不提供全球通用認證名單，也不宣稱所有礦物性產品都對所有水生生物無影響。
