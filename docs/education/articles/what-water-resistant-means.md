...
summary: "Water-resistant 代表產品在特定測試條件與標示時間內維持防護，不代表永久防水；游泳、流汗或擦乾後仍要依產品標示重新補擦。"
...
「抗水」（water-resistant）不是「防水」。它通常表示產品經過特定測試後，在游泳或流汗等情境下，能在標示的時間內維持相應防護；常見的標示是 40 或 80 分鐘。這個時間不是擦完後可以在陽光下待多久，也不是代表 40 或 80 分鐘後才需要第一次補擦。

實際使用時，先看你手上產品的標籤與說明。沒有標示抗水時間，就不要從「防汗」「戶外」或品牌名稱自行推算。碰水、流汗或用毛巾擦乾後，通常都應提早重新塗抹。
...
不同國家與產品標示制度可能不同，因此 UVAlert 只把 40／80 分鐘當作閱讀標籤的例子，不自動替使用者套用一個時間。
