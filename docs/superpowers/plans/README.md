...
| [`2026-08-26-codebase-consolidation-audit.md`](2026-08-26-codebase-consolidation-audit.md) | **盤點清單，7 個 Open Question 已於 2026-08-26 裁決。已完成：C2（刪 Claude Design 匯出，`3f38a9d`）、C1（drift 測試，`b1cf1db`）、A1＋A6（Stylelint ＋ CLAUDE.md，`fd54628`）、D1–D5（`DESIGN.md` 校準：colors/rounded/spacing/layout 全對齊、`saved` 色改藕紫、砍第 5 級文字色與 shadow token、斷點改 rem，尚未 commit）。** 其餘 A2–A5／B／E–G 未動工、彼此獨立可分 session 挑做。字級量表重新對齊拆成 B8。現況數字動工前需重新 grep 核對 | [`../../decisions/2026-08-25-*.md`](../../decisions/) 六份、[`../../../DESIGN.md`](../../../DESIGN.md) §10／§12／§13、`packages/ui/src/styles.css`、`apps/web/src/assets/app.css`、`packages/ui/src/tokens.test.ts`、`stylelint.config.mjs` |
