...
> ⚠️ **其中兩項與 `防曬晴報員PRD.md` v3.9 有落差，實作前必須先修 PRD：**
>
> - **兩步設定流程**——PRD §5.2 第 2、4、10 點與 AC-34 明文要求三畫面與獨立最終確認頁。這是**直接衝突**，PRD 為文件權威第一順位，下游文件不得覆蓋。
> - **防曬裝備清單**——PRD F-05 只定義防曬產品標示，沒有裝備品類。這是**範圍擴充**，需要 F-05 一併修訂。
>
> 另兩項（S-04 揭露層次、Q&A 只做 App 內）與 PRD 一致，S-04 甚至是修正實作對 PRD §5.2 第 5 點的既有偏離。
>
